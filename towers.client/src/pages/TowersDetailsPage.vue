...
<div class="container">
  <section v-if="activeTower" class="row lighter-color mt-4 rounded">
    ...
    <div class="col-md-8 col-6">
      ...
      <div>
        <span class="pe-2">Event Hosted By: </span>
        <img class="ticket-img" :src="activeTower.creator.picture" alt="">
        <span class='ps-2'>{{ activeTower.creator.name }}</span>
        <p class="text-end">Type of Event: {{activeTower.type}}</p>
      </div>
    </div>
